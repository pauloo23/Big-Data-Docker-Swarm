...
docker pull pauloo23/presto-worker2:0.251
...
mkdir -p /data/hadoop/hdfs/slave2
mkdir -p /data/hadoop/logs/slave2
...
mkdir /data/zookeeper/data/node3
mkdir /data/zookeeper/logs
mkdir /data/zookeeper/logs/node3
